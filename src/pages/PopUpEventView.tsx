          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {eventData.brandSite && (
                  <Button
                    className="w-full gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white border-0"
                    onClick={() => navigate(`/popup/${eventData.id}/site`)}
                  >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {eventData.brandSite && (
                  <div className="rounded-lg border border-purple-200 bg-purple-50/70 p-4 dark:border-purple-800 dark:bg-purple-950/20">
                    <p className="text-sm text-muted-foreground mb-3">
                      Extra event info, brochure, brand downloads and project resources.
                    </p>
                    <Button
                      className="w-full gap-2 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white border-0"
                      onClick={() => navigate(`/popup/${eventData.id}/site`)}
