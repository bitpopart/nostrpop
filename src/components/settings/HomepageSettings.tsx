...
const BUTTON_ICON_OPTIONS: { value: string; label: string; Icon: React.ComponentType<{ className?: string }> }[] = [
  ...
  { value: 'Printer', label: 'Printer 🖨️', Icon: Printer },
  { value: 'Frame', label: 'Frame 🖼', Icon: Frame },
  { value: 'Tag', label: 'Tag 🏷️', Icon: Tag },
  { value: 'Ticket', label: 'Ticket 🎟️', Icon: Ticket },
  ...
  { value: 'PenTool', label: 'Pen Tool ✒️', Icon: PenTool },
